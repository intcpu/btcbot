...
BITFINEX_HOST = 'wss://api.bitfinex.com/ws'
class bitfinexWebsocket(websocketClient):
    """"""
    ...
    def connect(self, symbols, proxy_host=None, proxy_port=None):
        """"""
        self.init(BITFINEX_HOST, proxy_host, proxy_port)
